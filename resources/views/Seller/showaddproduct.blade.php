...
<link rel="stylesheet" href="{{ asset('css/seller/addproduct.css') }}">
@endsection
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <div class="md-form md-outline input-with-post-icon">
                                                        ...
                                                        <input type="text"
                                                        name="product__price"
                                                        value="{{ old('product__price') }}" id="product__price" class="form-control"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <div class="md-form md-outline input-with-post-icon">
                                                        ...
                                                        <input type="text"
                                                        name="product__stock"
                                                        value="{{ old('product__stock') }}"  id="product__stock" class="form-control"
                                                        onkeypress="return isNumber(event)">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    placeholder="Product description">{{ old('product__description') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <hr class="bg-white">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    value="{{ old('files[]') }}" name="files[]" multiple>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
...
<script src="{{ asset('/js/seller/addproduct.js') }}"></script>
@endsection
