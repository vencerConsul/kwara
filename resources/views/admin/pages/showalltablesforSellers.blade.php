    ...
    <aside class="main-sidebar sidebar-light-light elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex  align-items-center">
                ...
                <div class="info">
                    <a href="{{route('admin.home')}}" class="d-block text-capitalize">{{ Auth::user()->name }}</a>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Registered Sellers</h3>
                                <span class="badge badge-danger float-right">{{$total_sellers->count()}} Members</span>
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                ...
                                                @else
                                                <img class="img-fluid showtable-profile" src="{{ asset('/profile_images/' .$s->profile. ' ') }}" alt="">
                                                @endif
                                            </td>
                                            <td class="text-capitalize">{{ $s->firstname .' '.$s->lastname }}</td>
                                            <td>{{ $s->status }}</td>
                                            <td>{{ $s->created_at->diffForHumans() }}</td>
                                            <td>
                                                {{ date('l, F d y, h:i a', $s->expiration_date) }}
                                            </td>
                                            <td class="text-center">
                                                <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-primary">
                                                    ...
                                                    @if($s->status == "approved" || $s->status == "resumed")
                                                    <a class="dropdown-item" href="/administrator/registered-sellers/resumed-seller-registration/{{$s->id}}">Resume</a>
                                                    <a class="dropdown-item" href="/administrator/registered-sellers/not-approve-seller-registration/{{$s->id}}">Not approved</a>
                                                    <a class="dropdown-item" href="#">Edit</a>
                                                    <a class="dropdown-item text-danger" href="#">Delete</a>
                                                    @else
                                                    <a class="dropdown-item" href="/administrator/registered-sellers/approved-seller-registration/{{$s->id}}">Approved</a>
